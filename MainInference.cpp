...
// 		// string FLAGS_d = "CPU"; //"GPU";
// 		// //string FLAGS_m = "yolov5l_v4.xml";
// 		// //string FLAGS_m = "yolov5l_v4_int8_cpu.xml";
// 		// //string FLAGS_m = "yolov5l_v4_640.xml";
// 		// string FLAGS_m = "yolov5l_v4_640_int8_cpu.xml"; 
// 		// string FLAGS_i = "bus.jpg";
// 		// //string FLAGS_i = "zidane.jpg";

// 		// int FLAGS_nt = 10;

// 		// cout << "Model name = " << FLAGS_m << endl;
// 		// cout << "Image name = " << FLAGS_i << endl;
// 		// cout << "starting" << endl;
// 		// const Version *IEversion;
// 		// IEversion = GetInferenceEngineVersion();
// 		// cout << "InferenceEngine: API version " << IEversion->apiVersion.major << "." << IEversion->apiVersion.minor << endl;
...
// // 		double _cof_threshold = 0.5;                //置信度阈值,计算方法是框置信度乘以物品种类置信度
// // 		double _nms_area_threshold = 0.5;  //nms最小重叠面积阈值
...
// // 			/*cv::putText(jpg, "label="+std::to_string(label[final_id[i]]), cv::Point2f(xmin, ymin), cv::FONT_HERSHEY_TRIPLEX, 0.7, cv::Scalar{ 0, 0, 255 });*/
// // 			cv::putText(jpg, names[label[final_id[i]]], cv::Point2f(xmin, ymin), cv::FONT_HERSHEY_TRIPLEX, 0.7, cv::Scalar{ 0, 0, 255 });
// // 			cv::rectangle(jpg, rect, cv::Scalar(0, 0, 255), 1, cv::LINE_8, 0);
